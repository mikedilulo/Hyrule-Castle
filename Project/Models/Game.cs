...
namespace ConsoleAdventure.Project.Models
{
  public class Game : IGame
  {
    ...
    public void Setup()
    {
      ...
      Room courtyard = new Room("Courtyard", "You have tip toed back to the opening of the courtyard, you look inside and notice that all the guard are all passed out. You see fresh tracks of a guard that has left the courtyard to go talk to Ganon. To your north, you see the Throne Room. This room may just contain the princess after all. Now you hear the voice 'Brave Adventurer, I am here.. help me please'. Hearing that has motivated you in knowing that you finally hear this voice that you have been hearing all along. It is time to move forward and go save the princess");

      Room hallway = new Room("Hallway", "As you move further along in the adventure you see this mysterious hallway that leads to the Throne Room. This hallway contains pictures of the princess and the royal family before the corruption happened. You still hear the voices in your head about saving this princess. To your East you see a short hallway with one room. This might be worth checking out. If you treck down the hallway towards the Throne Room it may be a trap. Always better to be extra precautious.");

      Room squire = new Room("Squire Tower", "You climb up to the top of the tower to see if you can get a good insight from the crows next about the situation outside once you grab the princess. You do not see a person in sight. There must have been a big party tonight as all the guards are still passed out in the courtyard.");

      Room council = new Room("Council-Room", "You poke your head into the Council Room as you hear some faint whispering. Its the weird bald dude who knows everything from Game of Thrones! He tells you that your destiny and rescue is in the Throne Room. Do you really trust this guy? To the south takes you back to the base of the tower.");

      Room throne = new Room("Throne Room", "Here lies the room where the Princess is. She gives you a big hug and thanks you for saving her. She has been so sick and so worried about her family. You do know that you will come back to avenge Ganon and finish him off for good. To the East within the room, you see a portal start to form. I think its about time to make the great escape.");

      Room completion = new Room("Completion", "You and the Princess jump through the portal and end up back in front of the castle where it all started. Everybody from the village has come out to cheer you on. Congratulations brave adventurer, you have completed your quest in saving the princess. There will be more to the game coming soon. Make sure you come back for more adventure in the future");
